...
interface HederaStartNodeProps {
  id: string;
...
export default function HederaStartNode({ 
  id, 
  position, 
  isDragging, 
  onMouseDown, 
  ...
  const middlewares = ['Pyth', 'Chainlink', 'Band Protocol'];
    ...
    >
          ...
          <div className="flex items-center gap-4">
            ...
            <h3
              style={{
                ...
                background: 'linear-gradient(to bottom, #a78bfa 0%, #8b5cf6 50%, #7c3aed 100%)',
            ...
            {!hasChildren && (
              ...
              <div
                style={{
                  width: '60px',
                  height: '2px',
                  background: 'linear-gradient(90deg, rgba(139, 92, 246, 0.6), rgba(168, 85, 247, 0.3))',
      ...
      {selectedProtocol && (() => {
        ...
        return (
          ...
          >
            <defs>
              <linearGradient id="lineGradientHedera" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: 'rgba(139, 92, 246, 0.6)', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: 'rgba(168, 85, 247, 0.3)', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            <path
              d={pathData}
              stroke="url(#lineGradientHedera)"
              strokeWidth="2"
              fill="none"
              style={{
      ...
      {selectedMiddleware && (() => {
        ...
        return (
          ...
          >
            <defs>
              <linearGradient id="middlewareLineGradientHedera" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: 'rgba(139, 92, 246, 0.6)', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: 'rgba(168, 85, 247, 0.3)', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            <path
              d={pathData}
              stroke="url(#middlewareLineGradientHedera)"
              strokeWidth="2"
              fill="none"
              style={{
                filter: 'drop-shadow(0 0 10px rgba(139, 92, 246, 0.4))',
      ...
      {selectedContract && (() => {
        ...
        return (
          ...
          >
            <defs>
              <linearGradient id="contractLineGradientHedera" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: 'rgba(139, 92, 246, 0.6)', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: 'rgba(168, 85, 247, 0.3)', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            <path
              d={pathData}
              stroke="url(#contractLineGradientHedera)"
              strokeWidth="2"
              fill="none"
              style={{
                filter: 'drop-shadow(0 0 10px rgba(139, 92, 246, 0.4))',
