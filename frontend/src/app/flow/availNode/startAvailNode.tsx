...
export default function AvailStartNode({ 
  id, 
  position, 
  isDragging, 
  onMouseDown, 
  ...
  const protocols = ['Wormhole', 'LayerZero', 'Axelar', 'Avail Nexus ADK'];
  const middlewares = ['Pyth', 'Chainlink', 'Band Protocol', 'Avail account'];
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <div
          ...
          style={{
            width: '420px',
            height: '140px',
            background: 'linear-gradient(135deg, rgba(0, 200, 150, 0.15), rgba(0, 180, 130, 0.1))',
            border: '1px solid rgba(0, 200, 150, 0.4)',
            borderRadius: '24px',
            cursor: isDragging ? 'grabbing' : 'grab',
            backdropFilter: 'blur(10px)',
            boxShadow: isExecuting 
              ? '0 0 80px rgba(0, 200, 150, 0.8), 0 0 120px rgba(0, 200, 150, 0.6), 0 10px 60px rgba(0, 200, 150, 0.5), inset 0 0 40px rgba(0, 200, 150, 0.2)' 
              : '0 0 20px rgba(0, 200, 150, 0.2), inset 0 0 20px rgba(0, 200, 150, 0.05), 0 10px 40px rgba(0, 0, 0, 0.3)',
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: '22px',
              borderRadius: '50%',
              background: 'linear-gradient(135deg, rgba(0, 200, 150, 0.8), rgba(0, 180, 130, 0.6))',
              border: '1px solid rgba(0, 200, 150, 0.4)',
              backdropFilter: 'blur(10px)',
              boxShadow: '0 4px 12px rgba(0, 200, 150, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
            }}
          />
          ...
          <div className="flex items-center gap-4">
            ...
            <h3
              style={{
                ...
                background: 'linear-gradient(to bottom, #00C896 0%, #00B884 50%, #00A872 100%)',
          ...
          {/* Right Side - Connection Point and Plus Button */}
            ...
            >
            {/* Green Circle - Always visible */}
              <div
                className="w-5 h-5 rounded-full"
                style={{
                  background: 'linear-gradient(135deg, rgba(0, 200, 150, 0.8), rgba(0, 180, 130, 0.6))',
                  border: '2px solid rgba(0, 200, 150, 0.5)',
                  boxShadow: '0 0 15px rgba(0, 200, 150, 0.5), 0 2px 8px rgba(0, 0, 0, 0.3)',
                }}
              />
            ...
            {!hasChildren && (
              ...
              <div
                style={{
                  width: '60px',
                  height: '2px',
                  background: 'linear-gradient(90deg, rgba(0, 200, 150, 0.6), rgba(0, 180, 130, 0.3))',
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'rgba(0, 200, 150, 0.3)';
              ...
              >
                <svg className="w-5 h-5" fill="none" stroke="#00C896" viewBox="0 0 24 24" strokeWidth={2.5}>
          ...
          <div className="flex flex-col items-center" ref={protocolDiamondRef}>
            ...
            <div
              style={{
                width: '24px',
                height: '24px',
                background: 'linear-gradient(135deg, rgba(0, 200, 150, 0.9), rgba(0, 180, 130, 0.8))',
                transform: 'rotate(45deg)',
                border: '1px solid rgba(0, 200, 150, 0.4)',
                boxShadow: '0 0 20px rgba(0, 200, 150, 0.5), 0 4px 12px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                transition: 'all 0.3s ease',
              }}
            ...
            <span
              ...
              >
                {selectedProtocol || 'Protocols/SDK'}
              </span>
            </div>
      ...
      {selectedProtocol && (() => {
        ...
        const gradientId = selectedProtocol === 'Avail Nexus ADK' ? 'availNexusLineGradient' : 'availLineGradient';
        return (
          <svg
            className="absolute"
            style={{
          ...
          >
            <defs>
              {selectedProtocol === 'Avail Nexus ADK' ? (
                <linearGradient id="availNexusLineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: 'rgba(0, 200, 150, 0.8)', stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: 'rgba(0, 180, 130, 0.5)', stopOpacity: 1 }} />
                </linearGradient>
              ) : (
                <linearGradient id="availLineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: 'rgba(0, 200, 150, 0.6)', stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: 'rgba(0, 180, 130, 0.3)', stopOpacity: 1 }} />
                </linearGradient>
              )}
            </defs>
            <path
              ...
              fill="none"
              style={{
                filter: selectedProtocol === 'Avail Nexus ADK'
                  ? 'drop-shadow(0 0 15px rgba(0, 200, 150, 0.6))'
                  : 'drop-shadow(0 0 10px rgba(0, 200, 150, 0.4))',
              }}
            />
          </svg>
        );
      ...
      {/* Draggable Circle with Protocol/SDK Logo - shown after protocol selection */}
      {selectedProtocol && (
        <div
        ...
        >
          <div
            ...
            style={{
              ...
              height: '80px',
              borderRadius: '50%',
              background: selectedProtocol === 'Avail Nexus ADK' 
                ? 'linear-gradient(135deg, rgba(0, 200, 150, 0.2), rgba(0, 180, 130, 0.15))'
                : 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05))',
              border: selectedProtocol === 'Avail Nexus ADK'
                ? '1px solid rgba(0, 200, 150, 0.4)'
                : '1px solid rgba(255, 255, 255, 0.3)',
              backdropFilter: 'blur(10px)',
              boxShadow: selectedProtocol === 'Avail Nexus ADK'
                ? '0 0 20px rgba(0, 200, 150, 0.3), inset 0 0 20px rgba(0, 200, 150, 0.1)'
          ...
          >
            ...
            <img 
              src={selectedProtocol === 'Avail Nexus ADK' ? '/availlogo.png' : '/layerzerologo.png'}
              alt={selectedProtocol === 'Avail Nexus ADK' ? 'Avail Nexus SDK Logo' : 'LayerZero Logo'}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'contain',
          ...
          <div className="flex flex-col items-center" style={{ marginTop: '16px', pointerEvents: 'none' }}>
            ...
            >
              {selectedProtocol === 'Avail Nexus ADK' ? 'Avail Nexus SDK' : 'Layer zero'}
            </span>
            <span
              style={{
                fontSize: '12px',
            ...
            >
              {selectedProtocol === 'Avail Nexus ADK' ? 'SDK' : 'Bridging'}
            </span>
          </div>
        </div>
      )}
      ...
      {selectedMiddleware && (() => {
        ...
        return (
          ...
          >
            <defs>
              <linearGradient id="availMiddlewareLineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: 'rgba(0, 200, 150, 0.6)', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: 'rgba(0, 180, 130, 0.3)', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            <path
              d={pathData}
              stroke="url(#availMiddlewareLineGradient)"
              strokeWidth="2"
              fill="none"
              style={{
        ...
        >
          <div
            ...
            style={{
              ...
              height: '80px',
              borderRadius: '50%',
              background: 'linear-gradient(135deg, rgba(0, 200, 150, 0.2), rgba(0, 180, 130, 0.15))',
              border: '1px solid rgba(0, 200, 150, 0.4)',
              backdropFilter: 'blur(10px)',
              boxShadow: '0 0 20px rgba(0, 200, 150, 0.2), inset 0 0 20px rgba(0, 200, 150, 0.05)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              padding: '12px',
          ...
          >
            ...
            <img 
              src={selectedMiddleware === 'Avail account' ? '/availlogo.png' : '/pythlogo.png'}
              alt={selectedMiddleware === 'Avail account' ? 'Avail Logo' : 'Pyth Logo'}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'contain',
          ...
          <div className="flex flex-col items-center" style={{ marginTop: '16px', pointerEvents: 'none' }}>
            ...
            >
              {selectedMiddleware === 'Avail account' ? 'Account' : 'Oracle'}
            </span>
          </div>
        </div>
      )}
      ...
      {selectedContract && (() => {
        ...
        return (
          ...
          >
            <defs>
              <linearGradient id="availContractLineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: 'rgba(0, 200, 150, 0.6)', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: 'rgba(0, 180, 130, 0.3)', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            <path
              d={pathData}
              stroke="url(#availContractLineGradient)"
              strokeWidth="2"
              fill="none"
              style={{
                filter: 'drop-shadow(0 0 10px rgba(0, 200, 150, 0.4))',
                ...
                <button
                  ...
                  style={{
                    ...
                    background: selectedProtocol === protocol 
                      ? 'linear-gradient(135deg, rgba(0, 200, 150, 0.3), rgba(0, 180, 130, 0.3))'
